...
while len(peaklist[:,0])!=0:
	...
	if newpeaklist[0]==23:
		print "X"+"\t"+str(int(newpeaklist[1]))+"\t"+str(int(newpeaklist[1])+res)+"\t"+"X"+"\t"+str(int(newpeaklist[3]))+"\t"+str(int(newpeaklist[3])+res)+"\t"+color+"\t"+str(int(newpeaklist[4]))+"\t"+str(newpeaklist[5])+"\t"+str(newpeaklist[6])+"\t"+str(newpeaklist[7])+"\t"+str(newpeaklist[8])+"\t"+str(int(newpeaklist[9]))+"\t"+str(int(newpeaklist[10]))+"\t"+str(int(newpeaklist[11]))+"\t"+str(int(newpeaklist[12]))+"\t"+str(newpeaklist[13])+"\t"+str(newpeaklist[14])+"\t"+str(newpeaklist[15])+"\t"+str(newpeaklist[16])+"\t"+str(int(numcollapsed))+"\t"+str(int(xcoord+(res/2)))+"\t"+str(int(ycoord+(res/2)))+"\t"+str(r)
	else:
		print str(int(newpeaklist[0]))+"\t"+str(int(newpeaklist[1]))+"\t"+str(int(newpeaklist[1])+res)+"\t"+str(int(newpeaklist[2]))+"\t"+str(int(newpeaklist[3]))+"\t"+str(int(newpeaklist[3])+res)+"\t"+color+"\t"+str(int(newpeaklist[4]))+"\t"+str(newpeaklist[5])+"\t"+str(newpeaklist[6])+"\t"+str(newpeaklist[7])+"\t"+str(newpeaklist[8])+"\t"+str(int(newpeaklist[9]))+"\t"+str(int(newpeaklist[10]))+"\t"+str(int(newpeaklist[11]))+"\t"+str(int(newpeaklist[12]))+"\t"+str(newpeaklist[13])+"\t"+str(newpeaklist[14])+"\t"+str(newpeaklist[15])+"\t"+str(newpeaklist[16])+"\t"+str(int(numcollapsed))+"\t"+str(int(xcoord+(res/2)))+"\t"+str(int(ycoord+(res/2)))+"\t"+str(r)
	r=0
